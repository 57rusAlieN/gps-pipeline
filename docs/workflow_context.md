...
**Все этапы завершены + бонусы.** 167/167 тестов зелёных.

Добавлен `GnssBinaryParser` (бинарный дамп `*.bin`, 196 байт/запись, little-endian) и `BinaryPipeline`. Формат описан в `docs/BINARY_FORMAT.md`.
